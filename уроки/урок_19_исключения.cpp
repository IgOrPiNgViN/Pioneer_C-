...
ИСКЛЮЧЕНИЕ - это событие, которое происходит во время выполнения программы и нарушает нормальный поток выполнения

МЕХАНИЗМ ОБРАБОТКИ ИСКЛЮЧЕНИЙ:
1. try - блок кода, в котором могут возникнуть исключения
2. catch - блок кода для обработки исключений
3. throw - оператор для генерации исключения
...
- Можно использовать catch(...) для всех исключений
- Исключения могут быть вложенными
- Можно перебрасывать исключения
