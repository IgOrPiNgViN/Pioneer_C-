...
- Освоить функции (урок 12) для передачи массивов в функции
- Изучить STL (урок 20) для работы с векторами и другими контейнерами
...
int main() {
    cout << "=== УРОК 7: ДВУМЕРНЫЕ МАССИВЫ ===" << endl;
